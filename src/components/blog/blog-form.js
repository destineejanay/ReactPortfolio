...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://destineemuse.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://destineemuse.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch",
      });
    }
  }
          ...
          {this.props.editMode && this.props.blog.featured_image_url ? (
            <div className="portfolio-manager-image-wrapper">
              ...
              <div className="image-removal-link">
                <a onClick={() => this.deleteImage("featured_image")}>Delete</a>
              </div>
            </div>
          ) : (
            <DropzoneComponent
